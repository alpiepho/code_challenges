...
// gcc fizz_buzz_recursive.c -o runme ; ./runme
...
void recurse(char **returnStrs, int index, int i, int n) {
    printf("index, i, n: %d %d %d\n", index, i, n);
    ...
    if (i <= n) {
        ...
        recurse(returnStrs, index+1, i+1, n);
    }
}
